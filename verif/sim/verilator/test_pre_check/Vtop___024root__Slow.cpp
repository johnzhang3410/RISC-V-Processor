...
extern const VlWide<11>/*351:0*/ Vtop__ConstPool__CONST_5b3cb0b3_0;
...
void Vtop___024root___initial__TOP__1(Vtop___024root* vlSelf) {
    ...
    // Body
    VL_READMEM_N(true, 32, 181, 0, VL_CVT_PACK_STR_NW(11, Vtop__ConstPool__CONST_5b3cb0b3_0)
    ...
    while (VL_GTS_III(1,32,32, 0xb5U, top__DOT__dut__DOT__core__DOT__imem__DOT__i)) {
        vlSelf->top__DOT__dut__DOT__core__DOT__imem__DOT____Vlvbound5 
            = ((0xb4U >= (0xffU & top__DOT__dut__DOT__core__DOT__imem__DOT__i))
                ? (0xffU & vlSelf->top__DOT__dut__DOT__core__DOT__imem__DOT__unnamedblk1__DOT__temp_arr
                   [(0xffU & top__DOT__dut__DOT__core__DOT__imem__DOT__i)])
                : 0U);
        ...
        vlSelf->top__DOT__dut__DOT__core__DOT__imem__DOT____Vlvbound6 
            = (0xffU & (((0xb4U >= (0xffU & top__DOT__dut__DOT__core__DOT__imem__DOT__i))
                          ? vlSelf->top__DOT__dut__DOT__core__DOT__imem__DOT__unnamedblk1__DOT__temp_arr
                         [(0xffU & top__DOT__dut__DOT__core__DOT__imem__DOT__i)]
                          : 0U) >> 8U));
    ...
    while (VL_GTS_III(1,32,32, 0xb5U, top__DOT__dut__DOT__core__DOT__dmem__DOT__i)) {
        vlSelf->top__DOT__dut__DOT__core__DOT__dmem__DOT____Vlvbound12 
            = ((0xb4U >= (0xffU & top__DOT__dut__DOT__core__DOT__dmem__DOT__i))
                ? (0xffU & vlSelf->top__DOT__dut__DOT__core__DOT__dmem__DOT__unnamedblk1__DOT__temp_arr
                   [(0xffU & top__DOT__dut__DOT__core__DOT__dmem__DOT__i)])
                : 0U);
        ...
        vlSelf->top__DOT__dut__DOT__core__DOT__dmem__DOT____Vlvbound13 
            = (0xffU & (((0xb4U >= (0xffU & top__DOT__dut__DOT__core__DOT__dmem__DOT__i))
                          ? vlSelf->top__DOT__dut__DOT__core__DOT__dmem__DOT__unnamedblk1__DOT__temp_arr
                         [(0xffU & top__DOT__dut__DOT__core__DOT__dmem__DOT__i)]
                          : 0U) >> 8U));
        if (VL_LIKELY((0x100000U >= (0x1fffffU & ((IData)(1U) 
...
void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    for (int __Vi0=0; __Vi0<181; ++__Vi0) {
