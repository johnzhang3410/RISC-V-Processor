...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , F_PC{vlSymsp->TOP.F_PC}
    , F_INSN{vlSymsp->TOP.F_INSN}
    , W_PC{vlSymsp->TOP.W_PC}
    , W_ENABLE{vlSymsp->TOP.W_ENABLE}
    , W_DESTINATION{vlSymsp->TOP.W_DESTINATION}
...
static void _eval_initial_loop(Vtop__Syms* __restrict vlSymsp) {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/z23ou/ece320/z23ou-pd5/verif/tests/test_pre_check.sv", 4, "",
